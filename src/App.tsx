...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto dark:bg-gray-800">
      <a href="" className="flex items-center pl-2.5 mb-5 ">
         ...
         <span className="ml-5 self-center text-xl font-semibold whitespace-nowrap dark:text-white"> Youtube</span>
      </a>
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Shorts</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <img className="rounded-full w-52 h-52" src={profile}  alt="image description"></img>
         <h2 className=' text-center text-white font-extrabold'>Musa Moyo</h2>
         <h2 className=' text-center text-white font-extrabold'>
            Systems Engineering Graduate
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <span className="flex-1 ml-1 bg-red-800 ">Linkden</span>
            </a>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <span className="flex-1 ml-1 bg-red-800 ">GitHub</span>
            </a>
            </h2>
...
<section>
<div className=" bg-black sm:ml-64">
